...
class Payments extends CI_Controller
{
    ...
    {
        // Pastikan model terkait dipanggil
        $this->load->model('ProductModel'); // Model untuk barang
        $this->load->model('OrderModel');   // Model untuk transaksi
        ...
        if ($order_id) {
            foreach ($cart as $item) {
                // Kurangi stok barang sesuai item di keranjang
                $this->Product_model->reduce_stock($item['id'], $item['qty']);
            }
        }
