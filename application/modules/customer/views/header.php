...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #ff0000;">
      <!-- Brand Logo -->
      <a href="<?php echo site_url(); ?>" class="brand-link" style="background-color: #ff0000;">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item">
              <a href="<?php echo site_url('customer'); ?>" class="nav-link active" style="background-color: #ff0000;">
                <i class="nav-icon fas fa-tachometer-alt"></i>
                <p>Dasbor</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="<?php echo site_url('customer/orders'); ?>" class="nav-link" style="background-color: #ff0000;">
                <i class="nav-icon fas fa-shopping-cart"></i>
                <p>Order Saya</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="<?php echo site_url('customer/payments'); ?>" class="nav-link" style="background-color: #ff0000;">
                <i class="nav-icon fa fa-money-bill"></i>
                <p>Pembayaran</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="<?php echo site_url('customer/reviews'); ?>" class="nav-link" style="background-color: #ff0000;">
