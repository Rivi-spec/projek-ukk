...
<div class="content-wrapper">
    ...
    <!-- Load Tempus Dominus Bootstrap4 -->
    <script src="https://cdn.jsdelivr.net/npm/tempusdominus-bootstrap-4@5.1.0/build/js/tempusdominus-bootstrap-4.min.js"></script>

    <script src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-naj9eMmGSbrSc_-m"></script>

    <!--  <script>
        document.getElementById('pay-button').onclick = function() {
            const orderId = <?php echo json_encode($data->id); ?>;

            // Debug - cek URL yang dibentuk
            const url = '<?= base_url("payment/token/") ?>' + orderId;
