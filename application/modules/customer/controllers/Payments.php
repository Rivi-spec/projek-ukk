...
class Payments extends CI_Controller
{
    public function __construct()
    {
        ...
        \Midtrans\Config::$serverKey = 'SB-Mid-server-9y6u1E7r5-huWxmGkriXTNlK'; // Ganti dengan server key Anda

        \Midtrans\Config::$clientKey = 'SB-Mid-client-naj9eMmGSbrSc_-m'; // Ganti dengan client key Anda

        \Midtrans\Config::$isProduction = false; // Set true jika Anda menggunakan mode produksi
