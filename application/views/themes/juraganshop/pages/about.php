...
<div class="hero-wrap hero-bread"
    style="background-image: url('<?php echo get_theme_uri('images/background04.jpg'); ?>');">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center"
                ...
                <a href="https://www.youtube.com/embed/JTHqmCg8EDU?list=TLPQMjgxMTIwMjLuz7OrZ5IwkQ"
                    class="icon popup-vimeo d-flex justify-content-center align-items-center title=" "
                    frameborder="0"
            ...
            <div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
                <div class="heading-section-bold mb-4 mt-md-5">
                    <div class="ml-md-0">
                        <h2 class="mb-4">Toko kami adalah toko online yang dapat memudahkan dalam membeli sebuah pakaian dan sepatu.</h2>
                    </div>
                </div>
                <div class="pb-md-5">
