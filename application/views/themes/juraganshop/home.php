...
<section id="home-section" class="hero">
    <div class="home-slider owl-carousel">
        <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/background01.jpg'); ?>);">
            <div class="overlay"></div>
            <div class="container">
                <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
                    <div class="col-md-12 ftco-animate text-center">
                        <h1 class="mb-2">Kami Menjual Segala Jenis Pakaian</h1>
                        <h2 class="subheading mb-4">Bahan Yang Terbuat Dari Material Berkualitas Tinggi</h2>
                        <p><a href="#products" class="btn btn-primary" style="background-color: #ff0000; border-color: #ff0000;">Belanja Sekarang!</a></p>
                    </div>
                </div>
            </div>
        </div>

        <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/background02.jpg'); ?>);">
            <div class="overlay"></div>
            <div class="container">
                <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
...
<section class="ftco-section">
    <div class="container">
        <div class="row justify-content-center mb-3 pb-3">
            <div class="col-md-12 heading-section text-center ftco-animate" style="background-color: #f8f9fa; padding: 40px 0; border-radius: 10px;">
                <span class="subheading" style="color: #ff0000; font-size: 18px; font-weight: bold; text-transform: uppercase;">Produk Terbaru</span>
                <h2 class="mb-4" style="color: #333333; font-size: 36px; font-weight: bold;"><?php echo get_store_name(); ?></h2>
                <p style="color: #666666; font-size: 16px; line-height: 1.6;"><?php echo get_settings('store_tagline'); ?></p>
            </div>
        </div>
    </div>
    <div class="container">
                                        ...
                                        <p class="price">
                                            <?php if ($product->current_discount > 0) : ?>
                                                <span class="mr-2 price-dc">Rp
                                                    <?php echo format_rupiah($product->price); ?></span>
                                                <span class="price-sale" style="color: #ff0000;">Rp
                                                    <?php echo format_rupiah($product->price - $product->current_discount); ?></span>
                                            <?php else : ?>
                                                <span class="mr-2"><span class="price-sale" style="color: #ff0000;">Rp
                                                        <?php echo format_rupiah($product->price - $product->current_discount); ?></span>
                                                <?php endif; ?>
                                        </p>
                                    </div>
    ...
    <div class="container">
        <div class="row justify-content-end">
            <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate">
                <span class="subheading" style="color: #ff0000;">Produk dengan Harga Terbaik</span>
                <h2 class="mb-4">Deal of the day</h2>
                <p style="color: #ff0000;"><?php echo $best_deal->description; ?></p>
                <h3><a href="#" style="color: #ff0000;"><?php echo $best_deal->name; ?></a></h3>
                <span class="price" style="color: #ff0000;">Rp <?php echo format_rupiah($best_deal->price); ?> <a href="#" style="color: #ff0000;">sekarang hanya Rp
