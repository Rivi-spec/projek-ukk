...
<footer class="ftco-footer ftco-section">
    <div class="container">
        <div class="row">
            <div class="mouse">
                <a href="#" class="mouse-icon" style="background-color: #ff0000;">
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
                        <li class="ftco-animate"><a href="https://wa.me/6282245021499"><span
                                    class="bi bi-whatsapp"></span></a>
                        </li>
                        <li class="ftco-animate"><a href="#"><span class="icon-facebook"></span></a></li>
                        <li class="ftco-animate"><a href="https://www.instagram.com/riviiihsn?igsh=MTVreWVkdmxwMXo3bw=="><span
                ...
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            ...
                            <li><a href="tel:6282245021499"><span class="icon icon-phone"></span><span
                                        class="text"><?php echo get_settings('store_phone_number'); ?></span></a></li>
                            <li><a href="mailto:ahmad.rivi05@gmail.com"><span class=" icon icon-envelope"></span><span
